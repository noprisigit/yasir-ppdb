...
<div class="row">
  <div class="col-xs-12">
    <form action="<?= base_url('student/payment/reupload') ?>" enctype="multipart/form-data" method="POST" class="form-horizontal" role="form">
          ...
          <div class="widget-main">
            <div class="form-group">
              ...
              <div class="col-sm-8">
                ...
                <input type="hidden" name="key" value="<?= md5($payment->id) ?>">
                <input type="text" name="nominal" class="form-control" value="<?= $payment->nominal ?>" required>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label no-padding-right"> Info Pembayaran <span class="text-danger">*</span> </label>
              <div class="col-sm-8">
                <input type="text" name="catatan" class="form-control" value="<?= $payment->description ?>" required>
              </div>
            </div>
            <div class="form-group">
